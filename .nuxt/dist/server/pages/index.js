...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/index.vue?vue&type=template&id=496bd968&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('v-container',{attrs:{"mb-12":""}},[_c('v-btn',{on:{"click":function($event){return _vm.display()}}},[_vm._v("Try me")]),_vm._v(" "),_c('v-btn',{on:{"click":function($event){return _vm.display2()}}},[_vm._v("Try me also")])],1)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/index.vue?vue&type=template&id=496bd968&
...
var VSheet = __webpack_require__(48);
...
/* harmony default export */ var VSheet_VSheet = (Object(mixins["a" /* default */])(binds_attrs, colorable, elevatable, measurable, roundable, themeable["a" /* default */]).extend({
  name: 'v-sheet',
  props: {
    outlined: Boolean,
    shaped: Boolean,
...
var VProgressCircular = __webpack_require__(52);
...
function positionable_factory(selected = []) {
  return external_vue_default.a.extend({
    name: 'positionable',
    props: selected.length ? Object(helpers["e" /* filterObjectOnKeys */])(availableProps, selected) : availableProps
  });
}
...
var VRipple = __webpack_require__(50);
...
function keyboardRippleShow(e) {
  if (!keyboardRipple && (e.keyCode === helpers["h" /* keyCodes */].enter || e.keyCode === helpers["h" /* keyCodes */].space)) {
    keyboardRipple = true;
    rippleShow(e);
  }
}
  ...
  methods: {
    ...
    onRouteChange() {
      ...
      this.$nextTick(() => {
        ...
        if (Object(helpers["g" /* getObjectValueByPath */])(this.$refs.link, path)) {
          this.toggle();
        }
      });
    },
...
const baseMixins = Object(mixins["a" /* default */])(components_VSheet, routable, positionable, sizeable, factory('btnToggle'), toggleable_factory('inputValue')
/* @vue/component */
);
...
installComponents_default()(component, {VBtn: VBtn_VBtn,VContainer: VContainer["a" /* default */]})
